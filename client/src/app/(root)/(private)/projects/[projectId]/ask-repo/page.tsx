...
const page = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center py-20 bg-neutral-100/80 dark:bg-neutral-900/30  gap-6">
      ...
      <div className="flex flex-col justify-start items-center w-2/3 gap-4">
        <Card className="w-full flex flex-col justify-evenly items-start shadow-none h-40 p-4">
          <Input
          ...
          <div className="flex justify-between items-center p-2 mt-10 w-full">
            ...
            <Button className="bg-neutral-700 border border-neutral-800 w-1/6">
              Ask
            </Button>
          </div>
        </Card>
        <div className="grid grid-cols-2 grid-rows-2 gap-2 w-full ">
          ...
          <Card className="p-3 shadow-none">
            <p className="text-sm text-neutral-600">Ask for the contributors</p>
          </Card>
          <Card className="p-3 shadow-none">
